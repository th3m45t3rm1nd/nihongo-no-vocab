  ...
  return (
    <div>
      ...
      {progress === questions.length ? (
        <div className="w-full py-10 p-4 bg-blue-500 text-white text-center">
          <h3 className="text-4xl font-serif font-medium">Summary</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
            {results.map((result, index) => (
              ...
              >
                <p className="text-center font-medium text-lg">{result.question}</p>
              </div>
            ))}
          </div>
